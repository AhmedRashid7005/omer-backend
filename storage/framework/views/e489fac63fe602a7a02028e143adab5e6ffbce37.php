<?php $__env->startSection('title', 'نظام الشحن'); ?>
        ...
        <div class="container">
            ...
            <div class="row flex-column-reverse flex-lg-row my-md-3 my-md-3">
                ...
                <div class="col-md-6 col-12 pl-md-0 text-right ">
                        <img class="figure-img img-fluid  w-100 m-0" src="<?php echo e(URL::asset('public/themeAssets')); ?>/images/opop.jpg">
                </div>
            </div>
            <!--row 1-->
            ...
            <div class="row  py-3 my-3">
                <div class="col-md-6  col-12 pr-md-0">
                        <img class="figure-img img-fluid w-100 m-0" src="<?php echo e(URL::asset('public/themeAssets')); ?>/images/shipping03.jpg">
                </div>
            ...
            <div class="row  flex-column-reverse flex-lg-row py-3 my-3">
                ...
                <div class="col-md-6 col-12 pl-md-0 text-right ">
                        <img class="figure-img img-fluid  w-100 m-0" src="<?php echo e(URL::asset('public/themeAssets')); ?>/images/shipping02.jpg">
                </div>
            </div>
            <!--row 3-->
            ...
            <div class="row py-3 my-3">
                <div class="col-md-6 col-12 pr-md-0">
                        <img class="figure-img img-fluid w-100 m-0" src="<?php echo e(URL::asset('public/themeAssets')); ?>/images/النصائح-للتسوق.jpg">
                </div>
            ...
            <div class="row flex-column-reverse flex-lg-row  py-3 my-3">
                ...
                <div class="col-md-6 col-12 pl-md-0 text-right ">
                        <img class="figure-img img-fluid  w-100 m-0" src="<?php echo e(URL::asset('public/themeAssets')); ?>/images/shipping01.jpg">
                </div>
            </div>
            <!--row 5-->
        </div>
            ...
            <div class="row">
                ...
                <!-- col-md-5 -->
                    <div class="col-md-5  col-12 text-left pt-md-5" >
                        <img class="figure-img img-fluid" src="<?php echo e(URL::asset('public/themeAssets')); ?>/images/sites.png">
                    </div>
                <!-- /col-md-5 -->
