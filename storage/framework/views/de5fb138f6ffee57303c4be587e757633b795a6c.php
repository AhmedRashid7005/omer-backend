...
<head>
    ...
    <!-- START CSS FILE -->
        <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('themeAssets/css/bootstrap.min.css')); ?>">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css">
        <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('themeAssets/css/style-ar.css')); ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('themeAssets/css/media.css')); ?>">
    <!-- END CSS FILE -->
    <!-- add by arafat -->
...
<body>
    ...
    <div class="top-nav position-fixed w-100 d-s-none " dir="rtl" style="top: 0px;">
        ...
        <div class="container">
            <a class="navbar-brand  text-right " href="<?php echo e(route('homeAr')); ?>"><img class="w-75 text-right" src="<?php echo e(URL::asset('themeAssets')); ?>/images/logo-ar.png" alt=""> </a>
            ...
            <div class="collapse navbar-collapse  " id="navbarSite">
                <ul class="navbar-nav ml-auto w-100 justify-content-lg-between">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-decoration-none  " href="<?php echo e(route('homeAr')); ?>"><img class="language" src="<?php echo e(URL::asset('themeAssets')); ?>/images/SA3.png"/>  </a>
                    </li>
          ...
          <div class="col-lg-10 col-sm-10 col-12 main-section">
            <div class="modal-content">
              <div class="col-lg-12 col-sm-12 col-12 user-img">
                <img src="<?php echo e(URL::asset('themeAssets')); ?>/images/man01.png">
              </div>
    ...
    <div class="footer " style=" margin-top: 80px;">
        ...
        <div class="col-md-3 text-center col-12">
            ...
            <div class="pages pb-3">
                ...
                <img src="<?php echo e(URL::asset('themeAssets')); ?>/images/ImageCr.png" class="img-fluid w-100 h-100 " style="  height: 250px; !important;   "  >
        </div>
            ...
            <!--col-md-3 -->
                <div class="col-md-3 col-12 text-right">
                    <div class="pages text-md-right text-center py-2">
                        <img class="img-fluid" style="width: 250px;" src="<?php echo e(URL::asset('themeAssets')); ?>/images/code-Qr.png" alt="">
                    </div>
                </div>
            <!--col-md-3 -->
        ...
        <!-- End Footer -->
            ...
            <script src="<?php echo e(URL::asset('themeAssets/js/jquery-3.2.1.slim.min.js')); ?>" ></script>
            <script src="<?php echo e(URL::asset('themeAssets/js/popper.min.js')); ?>"></script>
            <script src="<?php echo e(URL::asset('themeAssets/js/bootstrap.min.js')); ?>"></script>
            <script type="text/javascript" src="<?php echo e(URL::asset('themeAssets/js/wow.min.js')); ?>"></script>
            <script>
                new WOW().init();
            </script>
            ...
            <script type="text/javascript" src="<?php echo e(URL::asset('themeAssets/js/jquery-3.4.1.min.js')); ?>"></script>
            <script type="text/javascript" src="<?php echo e(URL::asset('themeAssets/js/main.js')); ?>"></script>
