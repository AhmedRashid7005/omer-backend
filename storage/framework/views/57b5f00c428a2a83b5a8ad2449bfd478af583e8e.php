...
<?php $__env->startSection('title', 'Package Product Add'); ?>
        ...
        <div class="col">
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('packageProductStoreFromPackageDetails')); ?>" method="post" id="packageProductStoreFromPackageDetails" >
                        <?php echo csrf_field(); ?>
