	...
	<div class="col">
		<section class="card">
			...
			<div class="card-body">
				...
				<form action="<?php echo e(route('orderStore')); ?>" method="post" enctype="multipart/form-data" id="orderForm">
                    <?php echo csrf_field(); ?>
                        <?php
	...
	<div class="col">
		<section class="card">
			...
			<div class="card-body">
				...
				<form action="<?php echo e(route('orderProductStore')); ?>" method="post" enctype="multipart/form-data" id="orderProductForm">
                    <?php echo csrf_field(); ?>
                        <?php
                        // Global variable
                        global $amount_type;
                ...
                <div class="col-lg-4" style="margin-top: 20px;"> 
                    <a href="<?php echo e(route('addMinimumPayamount')); ?>" onclick="return confirm('Are you sure?')"> <button class="btn btn-danger">End Product Adding</button> </a>
                </div>
...
$(document).ready(function(){
	...
	$('#orderForm').submit(function(event) {
	    ...
	    $.ajax({
	        url: '<?php echo e(route("orderStore")); ?>',
	        type: 'POST',              
	        data: formData,
	        processData: false,
	        contentType: false,
	...
	$('#orderProductForm').submit(function(event) {
	    ...
	    $.ajax({
	        url: '<?php echo e(route("orderProductStore")); ?>',
	        type: 'POST',              
	        data: formData,
	        processData: false,
	        contentType: false,
