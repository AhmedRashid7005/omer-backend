...
<?php $__env->startSection('title', 'تسجبل دخول'); ?>
    ...
    <!--section class="contact-us"-->
         <section class="other_nav_link" style="position: relative; top: 160px;">
            ...
            <?php echo $__env->make("template.flash", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <form id="myform" action="<?php echo e(route('customerLogin')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                <div class="row ">
                  ...
                  <!--select-->
                    ...
                    <div class=" col-md-12  text-center">
                        <div class="input-group mb-3" dir="rtl">
                            ...
                            <input type="text" id="email" class="form-control" name="email" required="required" placeholder="الآسم" value="<?php echo e(get_cookie('email')); ?>">
                        </div>
                    </div>
                <!--div name-->
                    ...
                    <div class=" col-md-12  text-center">
                        <div class="input-group mb-3" dir="rtl">
                            ...
                            oninput="InvalidMsg(this);" name="password"
                             required="required" aria-label="Username" aria-describedby="basic-addon1" placeholder="كلمه السر" value="<?php echo e(get_cookie('password')); ?>">
                        </div>
                     <div class="row">
                           <div class="col-6 text-center">
                            <a href="<?php echo e(route('subscriptionPlansAr')); ?>">تسجيل جديد </a>
                         </div>
                         <div class="col-6 text-center">
                            <a href="<?php echo e(route('forgotPasswordAr')); ?>">نسيت كلمة السر </a>
                         </div>
                     </div>
                    </div >
                <!--div email-->
        ...
        <div style="margin-top:140px; margin-bottom: 100px;">
            ...
            <div class="social_login">
               ...
               <div class="col-md-12">
                   <a href="<?php echo e(route('social.login','facebook')); ?>" class="btn btn-face btn-block"><button class=" btn-lg text-info"><i class="fab fa-facebook"></i> Sign in with <b>Facebook</b></button></a>

               </div>
               <div class="col-md-12">
                   <a href="<?php echo e(route('social.login','google')); ?>" class="btn btn-google btn-block"><button class="text-warning btn-lg"><i class="fab fa-google-plus-g"></i> Sign in with <b>Google</b></button></a>
               </div>

               <div class="col-md-12">
                    <a href="<?php echo e(route('social.login','twitter')); ?>" class="btn btn-twitter btn-block"><button class="text-primary btn-lg"><i class="fab fa-twitter"></i> Sign in with <b>Twitter</b></button></a>
               </div>
            </div>
        </div>
