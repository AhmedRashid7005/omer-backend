        ...
        <section class="body-sign">
            <div class="center-sign">
                <a href="/" class="logo float-left">
                    <img src="<?php echo e(URL::asset('public/adminAssets/img/logo.png')); ?>" height="54" alt="Porto Admin" />
                </a>
                        ...
                        <form action="<?php echo e(route('adminLoginCheck')); ?>" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <input name="email" type="email" class="form-control form-control-lg" id="email" required=""  value="<?php echo e(get_cookie('admin_email')); ?>"/>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <input name="password" type="password" class="form-control form-control-lg" required value="<?php echo e(get_cookie('admin_password')); ?>"/>
                                    <span class="input-group-append">
                                        <span class="input-group-text">
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <div class="checkbox-custom checkbox-default">
                                        <input id="RememberMe" name="remember_me" type="checkbox" value="checked" <?php echo e(get_cookie('remember_me')); ?> />
                ...
                <p class="text-center text-muted mt-3 mb-3">&copy; Copyright <?php echo e(date("Y")); ?>. All Rights Reserved.</p>
            </div>
        </section>
        <!-- end: page -->
