...
<?php $__env->startSection('title',' Shipping Add'); ?>
	...
	<div class="col">
		<section class="card">
			<header class="card-header">
				...
				<h2 class="card-title"><strong><?php echo e(str_replace("_", " ",$delivery_type )); ?> Shipping Add By Admin</strong></h2>
			</header>
			<div class="card-body">

				<form method="post" action="<?php echo e(route('ShippingStore')); ?>" id="ShippingStore">
					<?php echo csrf_field(); ?>
