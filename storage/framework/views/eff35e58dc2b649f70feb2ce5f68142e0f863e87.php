...
<style>
    ...
    .se-pre-con {
        ...
        height: 100%;
        z-index: 9999;
        background: url(<?php echo e(URL::asset('public/themeAssets')); ?>/images/loader.gif) center no-repeat #fff;
    }
</style>
<?php $__env->stopPush(); ?>
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="login-form">
               <div class="text-center social-btn">
                  ...
                  <span class="social_login">
                     ...
                     <a href="<?php echo e(route('social.login','facebook')); ?>" class="btn btn-face btn-block"><i class="fab fa-facebook"></i> Sign in with <b>Facebook</b></a>
                     <a href="<?php echo e(route('social.login','google')); ?>" class="btn btn-google btn-block"><i class="fab fa-google-plus-g"></i> Sign in with <b>Google</b></a>
                     <a href="<?php echo e(route('social.login','twitter')); ?>" class="btn btn-twit btn-block"><i class="fab fa-twitter"></i> Sign in with <b>Twitter</b></a>
                  </span>
               </div>
            </div>
         </div>
            <div class="row collapse " id="Delivery" style="margin-top: -250px;">
                ...
                <form id="regForm"  action="<?php echo e(route('subscribe')); ?>" method="post">
                       <?php echo csrf_field(); ?>
