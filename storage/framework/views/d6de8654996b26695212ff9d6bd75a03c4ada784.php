...
<head>
    ...
    <!-- START CSS FILE -->
        <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('public/themeAssets/css/bootstrap.min.css')); ?>">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css">
        <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('public/themeAssets/css/style-ar.css')); ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('public/themeAssets/css/media.css')); ?>">
    <!-- END CSS FILE -->
    <!-- add by arafat -->
...
<body>
    ...
    <div class="top-nav position-fixed w-100 d-s-none " dir="rtl" style="top: 0px;">
        ...
        <div class="container">
            <a class="navbar-brand  text-right " href="<?php echo e(route('homeAr')); ?>"><img class="w-75 text-right" src="<?php echo e(URL::asset('public/themeAssets')); ?>/images/logo-ar.png" alt=""> </a>
            ...
            <div class="collapse navbar-collapse  " id="navbarSite">
                <ul class="navbar-nav ml-auto w-100 justify-content-lg-between">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link text-decoration-none" href="<?php echo e(route('homeAr')); ?>">الرئيسية </a>
                    </li>
                    ...
                    <li class="nav-item list-unstyled  ">
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="<?php echo e(route('personalShopperAr')); ?>">المتسوق الشخصي </a>
                            <a class="dropdown-item" href="<?php echo e(route('importSolutionsAr')); ?>">حلول الاستيراد </a>
                            <a class="dropdown-item" href="<?php echo e(route('makeAnOrderToPurchaseAutoPartsAr')); ?>">طلب قطع غيار السيارات </a>
                            <a class="dropdown-item" href="<?php echo e(route('buyerSellerProtectionServiceAr')); ?>">خدمة حماية البائع والمشتري </a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item list-unstyled  ">
                        ...
                        <ul class="dropdown-menu text-right">
                            <li><a class="dropdown-item" href="<?php echo e(route('subscriptionPlansAr')); ?>">خطط الاشتراك</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('addressesUsaChinaAr')); ?>">العنوان الأمريكي والصيني</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('addressKsaInternationalAr')); ?>">العنوان السعودي - عالمي</a></li>
                            </ul>
                        </div>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link text-decoration-none  " href="<?php echo e(route('globalServicesAr')); ?>">خدمات عالمية  </a>
                    </li>

                    <li class="nav-item">
                        <!-- previous link was Calculator-AR.html -->
                        <a class="nav-link text-decoration-none  " href="<?php echo e(route("calculatorAr")); ?>">الحاسبة </a>
                    </li>


                    <li class="nav-item">
                        <a class="nav-link text-decoration-none  " href="<?php echo e(route('homeAr')); ?>"><img class="language" src="<?php echo e(URL::asset('public/themeAssets')); ?>/images/SA3.png"/>  </a>
                    </li>

                    

                    <li class="btn-danger rounded-1 px-4 py-2 ">
                        <a class=" text-decoration-none text-light  font-weight-bold" href="<?php echo e(route('subscriptionPlansAr')); ?>">التسجيل </a>
                    </li>
            ...
            <div class="container py-2">
                ...
                <div class="row w-100 mx-auto font-weight-bolder">
                 ...
                 <!--  <div class=" col-md col-4  px-1  text-center">
                    ...
                    <div class=" col-md col-4 px-1 text-center">
                            <a class="nav-link pl-0 pr-0 text-decoration-none  " href="<?php echo e(route('featuresAr')); ?>">المميزات</a>
                    </div>
                    <div class=" col-md col-4 px-1 text-center">
                            <a class="nav-link pl-0 pr-0 text-decoration-none  " href="<?php echo e(route('insuranceSolutionAr')); ?>">حلول التأمين</a>
                    </div>

                    <div class=" col-md col-4 px-1  text-center">
                        <a class="nav-link pl-0 pr-0 text-decoration-none  " href="<?php echo e(route("affiliateAr")); ?>">افليت </a>
                </div>

                    <div class=" col-md col-4  px-1 text-center">
                        <!-- link was List-stores-AR.html -->
                            <a class="nav-link pl-0 pr-0 text-decoration-none  " href="<?php echo e(route('storeAr')); ?>">تصفح المتاجر </a>
                    </div>
                         <div class=" col-md col-4 px-1  text-center">
                    ...
                    <div class="btn-danger rounded-1 px-2 py-1 ">
                        <a class="nav-link py-1 text-decoration-none text-light" href="<?php echo e(route('loginAr')); ?>">دخول</a>
                    </div>
                ...
                <div class="row   w-100 py-2">
                    <div class="col-6">
                      <div class=" btn-danger rounded-1  w-75">
                        <a class="nav-link  text-decoration-none text-light" href="<?php echo e(route('loginAr')); ?>">  دخول </a>
                    </div>
                    </div>
          ...
          <div class="col-lg-10 col-sm-10 col-12 main-section">
            <div class="modal-content">
              <div class="col-lg-12 col-sm-12 col-12 user-img">
                <img src="<?php echo e(URL::asset('public/themeAssets')); ?>/images/man01.png">
              </div>
    ...
    <div class="footer " style=" margin-top: 80px;">
        ...
        <div class="col-md-3 text-center col-12">
            ...
            <div class="pages pb-3">
                ...
                <img src="<?php echo e(URL::asset('public/themeAssets')); ?>/images/ImageCr.png" class="img-fluid w-100 h-100 " style="  height: 250px; !important;   "  >
        </div>
            ...
            <!--col-md-3 -->
                <div class="col-md-3 col-12 text-right">
                    <div class="pages text-md-right text-center py-2">
                        <img class="img-fluid" style="width: 250px;" src="<?php echo e(URL::asset('public/themeAssets')); ?>/images/code-Qr.png" alt="">
                    </div>
                </div>
            <!--col-md-3 -->
              ...
              <div class="col-md-3 col-12 text-right">
                  ...
                  <div class="pages">
                      <ul>
                          ...
                          <li><a href="<?php echo e(route('disputeAr')); ?>">النزاعات</a></li>
                          <li><a href="<?php echo e(route('forbiddensAr')); ?>">الممنوعات</a></li>
                          <li><a href="<?php echo e(route('websiteDevelopmentAr')); ?>">تطوير الموقع</a></li>
                          <li><a href="<?php echo e(route('proofOfMoneyTransferAr')); ?>">اثبات تحول المبلغ</a></li>
                      </ul>
                  </div>
                  <!-- end for other pages -->
              </div>
                  ...
                  <div class="col-md-3 col-12 text-right">
                      <div class="pages">
                          <ul>
                             ...
                             <li><a href="<?php echo e(route('contactUsAr')); ?>">اتصل بنا</a></li>
                             <li><a href="javascript:void()">الأسئلة الشائعة</a></li>
                             <li><a href="<?php echo e(route('termsConditionsAr')); ?>">الشروط والأحكام</a></li>
                             <li><a href="<?php echo e(route('privacyPolicyAr')); ?>">سياسة الخصوصية</a></li>
                  ...
                  <div class="col-md-3 col-12 text-right">
                      <div class="pages">
                          <ul>
                              ...
                              <li><a href="<?php echo e(route('aboutUsAr')); ?>">من نحن</a></li>
                              <li><a href="javascript:void()">وسائل الدفع</a></li>
                              <li><a href="<?php echo e(route('chargingSystemAr')); ?>">الشحن والتوصيل</a></li>
        ...
        <!-- End Footer -->
            ...
            <script src="<?php echo e(URL::asset('public/themeAssets/js/jquery-3.2.1.slim.min.js')); ?>" ></script>
            <script src="<?php echo e(URL::asset('public/themeAssets/js/popper.min.js')); ?>"></script>
            <script src="<?php echo e(URL::asset('public/themeAssets/js/bootstrap.min.js')); ?>"></script>
            <script type="text/javascript" src="<?php echo e(URL::asset('public/themeAssets/js/wow.min.js')); ?>"></script>
            <script>
                new WOW().init();
            </script>
            ...
            <script type="text/javascript" src="<?php echo e(URL::asset('public/themeAssets/js/jquery-3.4.1.min.js')); ?>"></script>
            <script type="text/javascript" src="<?php echo e(URL::asset('public/themeAssets/js/main.js')); ?>"></script>
