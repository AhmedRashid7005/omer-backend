...
<link href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css" rel="stylesheet" type="text/css"/>
	...
	<div class="container dashborad-buttons">
		<div class="row margin-bottom">
			...
			<a href="<?php echo e(route('billedPackageList')); ?>"><button class="btn btn-primary">Billed Packages (<?=$package_count[1]?>)</button></a>
			<a href="<?php echo e(route('readyPackageList')); ?>"><button class="btn btn-primary">Ready Packages (<?=$package_count[2]?>)</button></a>
		</div>
    </div>
    <?php
	...
	$(document).ready(function() {
		...
		<?php
			foreach($packages as $package):
				$route = $package->stage_no == 2 ? route("packageDetails", ['id' => $package->id]) : route("packageEdit", ['id' => $package->id]);
		?>		
		...
		/* $("input#package_autocomplete").on('change',function(event, ui){
			source: data,
