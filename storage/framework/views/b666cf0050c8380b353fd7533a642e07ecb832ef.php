...
<?php $__env->startSection('content'); ?>
	...
	<form action="<?php echo e(route('printPackages')); ?>" method="post">
		<input type="hidden" name="package_type" value="second">
		<?php echo csrf_field(); ?>
		<?php
			$title = "Second Stage";
			$tableHead = array(
			...
			$other_actions = array(				
				"Send To Client" => "send-package"
				// "Print A" => "package-print/a",
				// "Print B" => "package-print/b"
		);


			table_view( $title, $tableHead, $packageList, "", route("packageEdit"), route("packageDelete"), $other_actions);
		?>
