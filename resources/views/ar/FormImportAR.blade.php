                        ...
                        <div class="col-md-12 col-12 text-right" dir="rtl">
                            <div class="row bg-basket rounded font-weight-bolder py-3 my-3">
                                <ol class=" col-12 d-block pr-5 text-blue list-unstyled">ملاحظات هامة :
                                    ...
                                    <li class="my-2">‌ب. عند وجود رابط للمنتجات من المتاجر، <a href="{{route('formPersonalShopperAr')}}" class="text-primary">نموذج المتسوق الشخصي </a> لتوفير العمولة.  </li>
                                    ...
                                    <li class="my-2">و . لاستيراد او طلب شراء قطع غيار السيارات <a href="{{route('FormOrderAutoPartsAr')}}" class="text-primary">نموذج-قطع-غيار-السيارات</a>     </li>
                                    <li class="my-2"> ز . لمعرفة المميزات والرسوم يرجى مراجعة <a href="{{route('importSolutionsAr')}}" class="text-primary">حلول الإستيراد</a>    </li>
                                </ol>
