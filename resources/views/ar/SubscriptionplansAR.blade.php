        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12 " data-animation="fadeInLeft">
                  ...
                  <a href="{{route('signUpAr')}}?plan=3" class="btn btn-primary  ">اشتراك</a>
               ...
               <!-- col-md-4 -->
                <div class=" col-md-4 col-12 " data-animation="fadeInUp">
                    ...
                    <a href="{{route('signUpAr')}}?plan=2" class="btn btn-primary ">اشتراك</a>
                </div>
                ...
                <div class=" col-md-4 col-12 " data-animation="fadeInRight">
                    ...
                    <a href="{{route('signUpAr')}}?plan=1" class="btn btn-primary ">اشتراك</a>
                </div>
