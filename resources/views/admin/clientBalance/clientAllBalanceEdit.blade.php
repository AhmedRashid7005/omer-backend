	...
	<div class="col">
		<section class="card">
			...
			{{-- 	<a href="{{route("subscribePackageList")}}"><button class="btn btn-success">Subscriber Package List</button></a>
				...
				<h2 class="card-title"><strong>Client All Balance Edit Admin</strong></h2>
			</header>
			<div class="card-body">
				@if($clientBalance)
				<?php
					$title = "Client All Data Details";
					$clientData = array(
						"Suit" => $clientBalance->user->suit,
						"Name" => $clientBalance->user->name,
						"Available" => $clientBalance->Available,
						"Required" => $clientBalance->Required,
						"Withdraw" => $clientBalance->Withdraw,
						"Pending" => $clientBalance->Pending,
						"Receivable" => $clientBalance->Receivable,
						"Used" => $clientBalance->Used,
						"Points" => $clientBalance->Points,
						"Loan" => $clientBalance->Loan,
					);
