...
<link href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css" rel="stylesheet" type="text/css"/>
	...
	<div class="container dashborad-buttons">
		<div class="row margin-bottom">
			...
			<a href="{{route('billedPackageList')}}"><button class="btn btn-primary">Billed Packages (<?=$package_count[1]?>)</button></a>
			<a href="{{route('readyPackageList')}}"><button class="btn btn-primary">Ready Packages (<?=$package_count[2]?>)</button></a>
		</div>
    </div>
    <?php
